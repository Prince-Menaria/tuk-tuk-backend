...
public class VoiceChatController {
     ...
     */
    @Operation(
        summary = "Create New Voice Chat Room", 
    ...
    public ResponseEntity<MobileResponse<CreateRoomResponseDto>> createRoom(
        ...
        try {
            ...
            errorResponse.setMessage("Room create successful");
    ...
    @Operation(
        ...
        description = "Join an existing voice chat room. User will be added as listener initially."
    )
    @ApiResponses({
    ...
    @Operation(
        ...
        description = "Leave current voice chat room. Session statistics will be calculated."
    )
     ...
     */
    @Operation(
        summary = "Get Available Rooms List",
        description = "Get paginated list of available voice chat rooms with filtering options"
    )
    ...
    public ResponseEntity<MobileResponse<GetRoomListResponseDto>> getRoomList(
            ...
            @Parameter(description = "Filter by room type (PUBLIC/PRIVATE/ALL)")
            @RequestParam(defaultValue = "ALL") String roomType,
            
            @Parameter(description = "Filter by language")
            @RequestParam(required = false) String language,
            
            @Parameter(description = "Search in room name/description")
            @RequestParam(required = false) String search,
            
            @Parameter(description = "Sort by (POPULARITY/RECENT/NAME)")
    ...
    @Operation(
        ...
        description = "Get detailed information about a specific room including participants and recent messages"
    )
    ...
    public ResponseEntity<MobileResponse<GetRoomDetailsResponseDto>> getRoomDetails(
            ...
            @Parameter(description = "Include participant list")
            @RequestParam(defaultValue = "true") boolean includeParticipants,
            
            @Parameter(description = "Include recent messages") 
            @RequestParam(defaultValue = "true") boolean includeMessages,
            
            @Parameter(description = "Number of recent messages to include")
